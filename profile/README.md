...
| [assignment-90-e2e6e303e-external](https://github.com/hertie-dsl-demo-course-e1234/assignment-90-e2e6e303e-external) | private | Assignment 90: E2E external e2e6e303e |
| [assignment-90-e2e6e303e-private](https://github.com/hertie-dsl-demo-course-e1234/assignment-90-e2e6e303e-private) | private | Assignment 90: E2E private e2e6e303e |
| [assignment-90-e2e6e303e-public](https://github.com/hertie-dsl-demo-course-e1234/assignment-90-e2e6e303e-public) | private | Assignment 90: E2E public e2e6e303e |
| [assignment-90-e2e6e303e-shared](https://github.com/hertie-dsl-demo-course-e1234/assignment-90-e2e6e303e-shared) | private | Assignment 90: E2E shared e2e6e303e |
| [assignment-90-e2e6e303e-student-choice](https://github.com/hertie-dsl-demo-course-e1234/assignment-90-e2e6e303e-student-choice) | private | Assignment 90: E2E student-choice e2e6e303e |
...
| [**Release materials**](https://github.com/hertie-dsl-demo-course-e1234/.github/actions/workflows/release-materials.yml) | Manually release materials to student-facing cohort orgs *(NB: it is recommended to instead use the [scheduling function](https://github.com/hertie-data-science-lab/dsl-teaching-toolkit/blob/preview/docs/07-schedule-releases.md) for regular releases)*. Select path(s) for any folder or file, one or several at a time. | Run by instructor |
| [**Release assignment**](https://github.com/hertie-dsl-demo-course-e1234/.github/actions/workflows/release-assignment.yml) | Generate one private repo per student from a chosen `assignment-*` template repo. *(NB: it is recommended to instead use the [scheduling function](https://github.com/hertie-data-science-lab/dsl-teaching-toolkit/blob/preview/docs/07-schedule-releases.md) for regular releases)* | Run by instructor |
